...
def iterate_through_directory(root_directory: str):
    ...
    for file in repos_to_check[0]:
        path = pathlib.Path.home() / root_directory / file
        print(path)
    # for repository in repos_to_check[0]:
    #     all_files_changed = generate_file_list(repository)
    #     actions_files = determine_actions_files(all_files_changed)
    #     single_dataframe = iterate_actions_files
